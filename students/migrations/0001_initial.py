    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(db_column='f_name', max_length=50, validators=[django.core.validators.MinLengthValidator(3, message='"first_name" field value less then three symbols')], verbose_name='First name')),
                ('last_name', models.CharField(db_column='l_name', max_length=50, validators=[django.core.validators.MinLengthValidator(3)], verbose_name='Last name')),
